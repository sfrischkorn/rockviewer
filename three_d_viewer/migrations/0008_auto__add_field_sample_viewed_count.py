...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.viewed_count'
        db.add_column(u'three_d_viewer_sample', 'viewed_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.viewed_count'
        db.delete_column(u'three_d_viewer_sample', 'viewed_count')
